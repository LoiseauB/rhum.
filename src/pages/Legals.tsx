const Legals = () => {
  return (
    <article className="py-3">
      <h1 className="text-xl m-b-4">Mentions Légales</h1>

      <h2 className="text-lg m-b-2">Informations Générales</h2>
      <p>
        <strong>Nom du site web :</strong> Rhum.
        <br />
        <strong>URL du site :</strong> www.votresite.com
        <br />
        <strong>Responsable de publication :</strong> Votre Nom
        <br />
        <strong>Email de contact :</strong> bapt.loiseau@gmail.com
      </p>

      <h2 className="text-lg m-b-2 my-4">Hébergement</h2>
      <p>
      ...
      <p>
        Tout litige en relation avec l’utilisation du site www.votresite.com est
